  ...
  <div class="table-resource-root">
    ...
    <div class="chart-line">
      <bl-row class="component-title" just="space-between">
        <div>资源折线图： <span style="font-size: 12px;">查询最近{{ lineSearchParam.interval }}的流量信息，按每{{
          lineSearchParam.customInterval }}分钟聚合，资源: {{ lineSearchParam.resource }}</span></div>
        <el-button-group>
...
// ----------------------------------------< 资源列表 >----------------------------------------
interface ResourceRow { resource: string, success: number, avgRt: number, maxRt: number, minRt: number }
