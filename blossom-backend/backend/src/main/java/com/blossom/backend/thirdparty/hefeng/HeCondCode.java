...
public class HeCondCode {
    ...
    static {
        ...
        WEATHER_CODE_MAP.put("101",new Node("#wt-duoyun",       "多云"));
        WEATHER_CODE_MAP.put("102",new Node("#wt-duoyun",       "少云"));
        WEATHER_CODE_MAP.put("103",new Node("#wt-qingduoyun",   "晴间多云"));
        WEATHER_CODE_MAP.put("104",new Node("#wt-yin",          "阴"));
        WEATHER_CODE_MAP.put("150",new Node("#wt-qing",         "晴"));
        WEATHER_CODE_MAP.put("151",new Node("#wt-duoyun",       "多云"));
        WEATHER_CODE_MAP.put("152",new Node("#wt-duoyun",       "少云"));
        WEATHER_CODE_MAP.put("153",new Node("#wt-qingduoyun",   "晴间多云"));
        ...
        WEATHER_CODE_MAP.put("302",new Node("#wt-leijiayu",     "雷阵雨"));
        WEATHER_CODE_MAP.put("303",new Node("#wt-leijiayu",     "强雷阵雨"));
        WEATHER_CODE_MAP.put("304",new Node("#wt-leijiayu",     "阵雨冰雹"));
        ...
        WEATHER_CODE_MAP.put("310",new Node("#wt-leijiayu",     "暴雨"));
        WEATHER_CODE_MAP.put("311",new Node("#wt-leijiayu",     "大暴雨"));
        WEATHER_CODE_MAP.put("312",new Node("#wt-leijiayu",     "特大暴雨"));
        WEATHER_CODE_MAP.put("313",new Node("#wt-leijiayu",     "冻雨"));
        WEATHER_CODE_MAP.put("314",new Node("#wt-zhongyu",      "小到中雨"));
        WEATHER_CODE_MAP.put("315",new Node("#wt-leijiayu",     "中到大雨"));
        WEATHER_CODE_MAP.put("316",new Node("#wt-leijiayu",     "大到暴雨"));
        WEATHER_CODE_MAP.put("317",new Node("#wt-leijiayu",     "暴到大暴雨"));
        WEATHER_CODE_MAP.put("318",new Node("#wt-leijiayu",     "大暴特暴雨"));
        WEATHER_CODE_MAP.put("399",new Node("#wt-yu",           "雨"));
        WEATHER_CODE_MAP.put("400",new Node("#wt-xue",          "小雪"));
        WEATHER_CODE_MAP.put("401",new Node("#wt-daxue",        "中雪"));
        WEATHER_CODE_MAP.put("402",new Node("#wt-daxue",        "大雪"));
        WEATHER_CODE_MAP.put("403",new Node("#wt-daxue",        "暴雪"));
        WEATHER_CODE_MAP.put("404",new Node("#wt-daxue",        "雨夹雪"));
        WEATHER_CODE_MAP.put("405",new Node("#wt-daxue",        "雨雪天气"));
        WEATHER_CODE_MAP.put("406",new Node("#wt-daxue",        "阵雨夹雪"));
        WEATHER_CODE_MAP.put("407",new Node("#wt-xue",          "阵雪"));
        WEATHER_CODE_MAP.put("408",new Node("#wt-xue",          "小到中雪"));
        WEATHER_CODE_MAP.put("409",new Node("#wt-daxue",        "中到大雪"));
        WEATHER_CODE_MAP.put("410",new Node("#wt-daxue",        "大到暴雪"));
